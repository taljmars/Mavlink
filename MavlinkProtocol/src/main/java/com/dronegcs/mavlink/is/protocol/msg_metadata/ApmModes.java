...
public enum ApmModes {
	...
	FIXED_WING_CIRCLE (1,"MavlinkCircle",MAV_TYPE.MAV_TYPE_FIXED_WING),
	...
	ROTOR_AVOID_ADSB(19, "Avoid_ADSB",MAV_TYPE.MAV_TYPE_QUADROTOR),
	ROTOR_GUIDED_NOGPS(20, "Guided_NoGPS",MAV_TYPE.MAV_TYPE_QUADROTOR),
