...
public enum MAV_PARAM_COPTER implements MAV_PARAM_I {
    ...
    ARMING_CHECK(MAV_PARAM_GROUP_COPTER.ARDUCOPTER,94,1,MAV_PARAM_UNIT.FLAGS, new HashMap<Number, String>(){{put(0,"Disabled");put(1,"Enabled");put(-3,"SkipBaro");put(-5,"SkipCompass");put(-9,"SkipGPS");put(-17,"SkipINS");put(-33,"SkipParams/Rangefinder");put(-65,"SkipRC");put(127,"SkipVoltage");}},false,"","Allows enabling or disabling of pre-arming checks of receiver, accelerometer, barometer, compass and GPS"),
    ...
    FENCE_TYPE(MAV_PARAM_GROUP_COPTER.FENCE,1,1,MAV_PARAM_UNIT.FLAGS, new HashMap<Number, String>(){{put(0,"None");put(1,"Altitude");put(2,"Circle");put(3,"AltitudeAndCircle");put(4,"Polygon");put(5,"AltitudeAndPolygon");put(6,"CircleAndPolygon");put(7,"All");}},false,"","Enabled fence types held as bitmask"),
    ...
    INS_PRODUCT_ID(MAV_PARAM_GROUP_COPTER.INS,0,1,MAV_PARAM_UNIT.FLAGS, new HashMap<Number, String>(){{put(0,"Unknown");put(1,"unused");put(2,"unused");put(88,"unused");put(3,"SITL");put(4,"PX4v1");put(5,"PX4v2");put(256,"unused");put(257,"Linux");}},false,"","Which type of IMU is installed (MAV_PARAM_GROUP.ARDUCOPTER,read-only)."),
    ...
    RNGFND_FUNCTION(MAV_PARAM_GROUP_COPTER.RNGFND,0,1,MAV_PARAM_UNIT.FLAGS, new HashMap<Number, String>(){{put(0,"Linear");put(1,"Inverted");put(2,"Hyperbolic");}},false,"","Control over what function is used to calculate distance. For a linear function, the distance is (MAV_PARAM_GROUP.ARDUCOPTER,voltage-offset)*scaling. For a inverted function the distance is (MAV_PARAM_GROUP.ARDUCOPTER,offset-voltage)*scaling. For a hyperbolic function the distance is scaling/(MAV_PARAM_GROUP.ARDUCOPTER,voltage-offset). The functions return the distance in meters."),
    ...
    RNGFND_STOP_PIN(MAV_PARAM_GROUP_COPTER.RNGFND,-1,1,MAV_PARAM_UNIT.FLAGS, new HashMap<Number, String>(){{put(-1,"NotUsed");put(50,"Pixhawk AUXOUT1");put(51,"Pixhawk AUXOUT2");put(52,"Pixhawk AUXOUT3,53:Pixhawk,AUXOUT4,54:Pixhawk AUXOUT5");put(55,"Pixhawk AUXOUT6");put(111,"PX4 FMU Relay1");put(112,"PX4 FMU Relay2");put(113,"PX4IO,Relay1");put(114,"PX4IO Relay2");put(115,"PX4IO ACC1");put(116,"PX4IO ACC2");}},false,"","Digital pin that enables/disables rangefinder measurement for an analog rangefinder. A value of -1 means no pin. If this is set, then the pin is set to 1 to enable the rangefinder and set to 0 to disable it. This can be used to ensure that multiple sonar rangefinders don't interfere with each other."),
    ...
    TELEM_DELAY(MAV_PARAM_GROUP_COPTER.ARDUCOPTER,0,1,MAV_PARAM_UNIT.SECOND,new Range(0,30),false,"","The amount of time (in seconds) to delay radio telemetry to prevent an Xbee bricking on power up"),
    ...
    //    need to check percentenge - donest' tmake sense'
    THR_MAX(MAV_PARAM_GROUP_COPTER.ARDUCOPTER,1000,1,MAV_PARAM_UNIT.PERCENT,new Range(800,1000),false,"Throttle Maximum","The maximum throttle that will be sent to the motors. This should normally be left as 1000. "),
    //    need to check percentenge - donest' tmake sense'
    THR_MID(MAV_PARAM_GROUP_COPTER.ARDUCOPTER,510,1,MAV_PARAM_UNIT.PERCENT,new Range(300,700),false,"Throttle Mid Position","The throttle output (0 ~ 1000) when throttle stick is in mid position. Used to scale the manual throttle so that the mid throttle stick position is close to the throttle required to hover"),
    //    need to check percentenge - donest' tmake sense'
    THR_MIN(MAV_PARAM_GROUP_COPTER.ARDUCOPTER,130,1,MAV_PARAM_UNIT.PERCENT,new Range(0,300),false,"Throttle Minimum","The minimum throttle that will be sent to the motors to keep them spinning"),
...
//    need to check percentenge - donest' tmake sense'
    ...
    MAV_PARAM_COPTER(MAV_PARAM_GROUP_I group, Number defaultValue, int increment, MAV_PARAM_UNIT unit, Map<Number, String> options, boolean readOnly, String title, String description) {
        this.group = group;
