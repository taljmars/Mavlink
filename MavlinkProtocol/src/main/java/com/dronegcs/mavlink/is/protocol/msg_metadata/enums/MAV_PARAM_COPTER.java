...
public enum MAV_PARAM_COPTER implements MAV_PARAM_I {
    ...
    FENCE_ENABLE(MAV_PARAM_GROUP_COPTER.FENCE,1,1,MAV_PARAM_UNIT.FLAGS, new HashMap<Integer, String>(){{put(0,"Disabled");put(1,"Enabled");}},false,"","Allows you to enable (1) or disable (0) the fence functionality"),
    ...
    FLOW_ENABLE(MAV_PARAM_GROUP_COPTER.ARDUCOPTER,0,1,MAV_PARAM_UNIT.FLAGS, new HashMap<Integer, String>(){{put(0,"Disabled");put(1,"Enabled");}},false,"","Setting this to Enabled(1) will enable optical flow. Setting this to Disabled(MAV_PARAM_GROUP.ARDUCOPTER,0) will disable optical flow"),
