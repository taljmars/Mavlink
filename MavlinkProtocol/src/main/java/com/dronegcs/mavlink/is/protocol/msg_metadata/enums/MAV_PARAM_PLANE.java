...
public enum MAV_PARAM_PLANE implements MAV_PARAM_I {
    ...
    ARSPD_FBW_MAX(MAV_PARAM_GROUP_PLANE.ARDUPLANE,22,1,MAV_PARAM_UNIT.METER_PER_SECOND,new Range(5,100),false,"Maximum Airspeed","Maximum airspeed demanded in automatic throttle modes. Should be set slightly less than level flight speed at THR_MAX and also at least 50% above ARSPD_FBW_MIN to allow for accurate TECS altitude control."),
    ARSPD_FBW_MIN(MAV_PARAM_GROUP_PLANE.ARDUPLANE,9,1,MAV_PARAM_UNIT.METER_PER_SECOND,new Range(5,100),false,"Minimum Airspeed","Minimum airspeed demanded in automatic throttle modes. Should be set to 20% higher than level flight stall speed."),
    ...
    LOG_BITMASK(MAV_PARAM_GROUP_PLANE.ARDUPLANE,16254,1,MAV_PARAM_UNIT.BITMASK,new HashMap<Number, String>(){{put(0,"Disabled");put(1,"ATTITUDE_FAST");put(2,"ATTITUDE_MEDIUM");put(4,"GPS");put(65535,"All-Default");}},false,"Log bitmask","Bitmap of what on-board log types to enable. This value is made up of the sum of each of the log types you want to be saved. It is usually best just to enable all log types by setting this to 65535. The individual bits are ATTITUDE_FAST=1, ATTITUDE_MEDIUM=2, GPS=4, PerformanceMonitoring=8, ControlTuning=16, NavigationTuning=32, Mode=64, IMU=128, Commands=256, Battery=512, Compass=1024, TECS=2048, Camera=4096, RCandServo=8192, Sonar=16384, Arming=32768, FullLogs=65535"),
